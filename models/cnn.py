...
class CnnVanilla(nn.Module):
	...
	def __init__(self):
		...
		self.conv10 = nn.Conv3d(in_channels=layer_config['conv10']['in_channels'],
							   ...
							   kernel_size=layer_config['conv10']['kernel_size'], stride=layer_config['conv10']['stride'],
		...
		self.conv11 = nn.Conv3d(in_channels=layer_config['conv11']['in_channels'],
							   ...
							   kernel_size=layer_config['conv11']['kernel_size'], stride=layer_config['conv11']['stride'],
		...
		self.conv12 = nn.Conv3d(in_channels=layer_config['conv12']['in_channels'],
							   ...
							   kernel_size=layer_config['conv12']['kernel_size'], stride=layer_config['conv12']['stride'],
		...
		self.conv13 = nn.Conv3d(in_channels=layer_config['conv13']['in_channels'],
							   ...
							   kernel_size=layer_config['conv13']['kernel_size'], stride=layer_config['conv13']['stride'],
